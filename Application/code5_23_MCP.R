...
cisMVMR.Trans.MCP.presso <- Oracle.Trans.lasso(fdata_condi$betaGX_A0,fdata_condi$betaGY_A0,
                                               fdata_condi$betaGX_AK,fdata_condi$betaGY_AK,
                                               cv.lambd,Methodname='MCP')

IV.MCP <- list(fdata1j=fdata1j,
               fdata_NK1o=fdata_NK1o)

save(cisMVMR.Trans.MCP.presso,IV.MCP,file=paste0('code5_resultall_oua_',oua,'_ouy_',ouy,'_transMCP.Rdata'))
